            ...
            <div class="col-sm-8">
                <font face="myFirstFont">
                    <div class="title-action">
                        <button class="btn btn-primary " type="button" data-toggle="modal" data-target="#addprof"><i class="fa fa-plus"></i> Add</button>
                    </div>
                </font>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Search and view Professors</h5>
                                        ...
                                        while($row22 = mysqli_fetch_assoc($result22)) {
                                            ...
                                            <tr data-child-value="
                                                ...
                                                $matresult = mysqli_query($con, "
                                                        ...
                                                        Where professors.prid = $row22[prid]");
                                            ...
                                            "> <!--info plus-->
                                                ...
                                                <td class="middle wrap">
                                                    <font size="3">
                                                        <?php echo $row22['prmob']." - ".$row22['prtel'] ?>
                                                    </font>
                                                </td>
                                                <td class="middle wrap">
                                                    <font size="3">
                                                        <?php echo $row22['premail'] ?>
                                                    </font>
                                                </td>
                                                <td class="middle wrap">
                                                    <font size="3">
                                                        <?php
                                                        if ($row22['professorsrole'] == 1){
                                                            echo "Administrator";
                                                        }elseif($row22['professorsrole'] == 2){
                                                            echo "Power user";
                                                        }else{
                                                            echo "User";
                                                        }
